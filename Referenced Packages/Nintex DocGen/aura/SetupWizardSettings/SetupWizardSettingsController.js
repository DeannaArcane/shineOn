({
    init : function(component) {
        ...
        component.set('v.isGovCloud', orgSettings.isGovCloud);
        var subdomain = !orgSettings.subdomain && orgSettings.isGovCloud && !component.get('v.isDdpAdmin') ? 'gov' : orgSettings.subdomain;
        component.set('v.subdomain', subdomain);
        component.set('v.isGovSubdomain', subdomain === 'gov');
